...
{
    /**
     * @param int|null $user        The FrontendUser id
     * @param string|null $code     The double-opt-in confirmation code
     */
    public function registrationAction(int $user = null, string $code = null){
