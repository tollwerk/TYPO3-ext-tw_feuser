...
abstract class AbstractFormFactory extends \TYPO3\CMS\Form\Domain\Factory\AbstractFormFactory
{
    ...
    public function build(array $configuration, string $prototypeName = null): FormDefinition
    {
        ...
        $this->passthroughParameters = !empty($configuration['passthroughParameters']) ? $configuration['passthroughParameters'] : [];
    ...
    public function triggerFormBuildingFinished(FormDefinition $form)
    {
        ...
        foreach($this->passthroughParameters as $key => $value){
        ...
        parent::triggerFormBuildingFinished($form); // TODO: Change the autogenerated stub
    }
}
