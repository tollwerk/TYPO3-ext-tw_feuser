...
call_user_func(
    function() {
        ...
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue('twuser_feuserregistration',
            'FILE:EXT:tw_user/Configuration/FlexForm/FeuserRegistration.xml');
    }
);
